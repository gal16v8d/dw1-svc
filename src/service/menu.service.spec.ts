...
import mockList from '../__mocks__/menuList.json';
import { MenuService } from './menu.service';

const APP_ID = '1';

describe('MenuService test suite', () => {
  const requestData: MenuDto = {
  ...
  beforeEach(async () => {
    ...
    model = module.get<Model<Menu>>(getModelToken('Menu'));
  });
  ...
  it('should return single menu', async () => {
